...
* On changera le choix du dépôt par une liste déroulante afin de lister directement dans le formulaire les dépôts de l'utilisateur. 
* Utilisation d'un frameworkJS pour afficher les résultats (sencha/extjs serait un plus)
